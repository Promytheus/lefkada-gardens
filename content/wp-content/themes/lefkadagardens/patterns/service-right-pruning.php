<?php
/**
 * Title: Service Right Pruning
 * Slug: lefkadagardens/service-right-pruning
 * Categories: service, pruning, featured
 * Viewport width: 1400
 */
?>
...
<div class="wp-block-group lg-home-page-services alignfull" style="margin-top:0">
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group lg-home-page-service-graphic lg-home-page-service-graphic--right" style="margin-top:0">
        ...
        <div class="wp-block-column">
            <!-- wp:group {"style":{"spacing":{"margin":{"top":"0"}}}} -->
            <div class="wp-block-group lg-home-page-service-text lg-home-page-service-text--right" style="margin-top:0">
                ...
                <p class="has-text-align-left" style="margin-top:var(--wp--preset--spacing--10);margin-bottom:0">
                    Proper time & proper way of pruning according each plant & tree, separately
                </p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
